...
namespace nConvert {
	...
	inline glm::quat createOrientationEulerAngles(glm::vec3 newAnglesEuler) {

		const glm::vec3 orientation = glm::vec3(glm::radians(newAnglesEuler.x), glm::radians(newAnglesEuler.y), glm::radians(newAnglesEuler.z));
